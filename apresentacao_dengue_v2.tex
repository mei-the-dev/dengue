...
\begin{frame}{\faChartBar\ Casos por Ano — Resultados}
    \begin{columns}
        \begin{column}{0.55\textwidth}
            % Substituir gráfico TikZ por visualização real
            \begin{figure}
                \centering
                \includegraphics[width=0.98\linewidth]{output/tarefa1_curvas_por_ano.pdf}
                \caption*{\footnotesize Total de casos de dengue por ano (2010--2016).}
            \end{figure}
        \end{column}
        \begin{column}{0.43\textwidth}
...
\begin{frame}{Matrizes de Distância — Estatísticas (2013)}
    \begin{columns}
        ...
        \begin{column}{0.53\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.98\linewidth]{output/tarefa3_distribuicao_distancias_2013.pdf}
                \caption*{\footnotesize Distribuição das distâncias L1 e L2 entre municípios (2013).}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{block}{\faLink\ Top 10 Pares (menor distância L1)}
                \footnotesize
                % Tabela pode ser mantida ou gerada automaticamente
                \begin{tabular}{llc}
                    	oprule
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.98\linewidth]{output/tarefa3_pares_similares_2013.pdf}
                \caption*{\footnotesize Curvas normalizadas dos pares mais sincronizados (menor L1).}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
